...
const FAQ = [
  ...
  { q: "Как работает бартер?", a: "Раздел «Бартер» позволяет обмениваться вещами без денег. Укажите что предлагаете и что хотите получить — другие пользователи смогут предложить вам обмен." },
